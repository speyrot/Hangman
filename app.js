...
var word = [
    ...
    ["Elephant", "A large, grey mammal with a long trunk."],
    ["Pizza", "A popular dish made of dough, tomato sauce, and toppings."],
    ["Sunflower", "A tall plant with large, yellow flowers."],
    ["Beach", "A sandy shoreline along a body of water."],
    ["Chocolate", "A sweet treat made from cacao beans."],
    ["Mountain", "A tall landform that rises high above the surrounding area."],
    ["Rainbow", "A colorful arc in the sky formed by sunlight and rain."],
